...
import baggyone from "../assets/baggyone.png";
import baggytwo from "../assets/baggytwo.png";
import baggythree from "../assets/baggythree.png";
// import Footer from "../components/Footer"
// import cart from "../assets/cart.svg";
// import cart from "../assets/cart.svg";
// import arrivals from "../assets/arrivals.png"
// import one from "../screens/one.css"
...
const Morebagstwo = () => {
  return (
    <>
         <Navbar />
			...
			<div className="home">
				...
				<p class="">Hottest offer</p>
				<span className='arr-right'><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" fill="currentColor" class="bi bi-chevron-right arr-right" viewBox="0 0 16 16">
					<path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708z" />
				</svg> </span>
				...
				<p class="n">Wholesale & Discount</p>
			</div>
            <div className='rec'>
            <h2 className='whole'>WHOLESALE & DISCOUNT SALE</h2>
			<div className='rectangle'>
            <img src={baggyone} alt="bag" />
			<img src={baggytwo} alt="bag" />
			<img src={baggythree} alt="bag" />
			<img src={baggythree} alt="bag" />
			</div>
            </div>
	...
	<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chevron-left" viewBox="0 0 16 16">
				...
				<Link to="/Morebagsthree"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#2b3991" class="bi bi-2-square" viewBox="0 0 16 16">
